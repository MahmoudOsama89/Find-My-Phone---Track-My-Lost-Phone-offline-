   ...
   LatLng sydney ;
    ...
    private void viewmaps(){
        try {
            ...
            //Toast.makeText(this,"ViewMap works fine ",Toast.LENGTH_LONG).show();

        }
        catch(Exception ex){
           // Toast.makeText(this,"ViewMap wrong ",Toast.LENGTH_LONG).show();
            //String x= String.valueOf(ex.getStackTrace()).toString();
           // Toast.makeText(this,"error is "+ex+"   "+x,Toast.LENGTH_LONG).show();
           // Log.e("boot_broadcast_poc", "map error is  "+ex+"   "+x);
        }
          }
...
switch (Viewway){
    ...
    private void addMarker(){
        ///Toast.makeText(this,"admaker works fine ",Toast.LENGTH_LONG).show();
        String CurrentString=SettingSaved.Userlocationinthemap;
